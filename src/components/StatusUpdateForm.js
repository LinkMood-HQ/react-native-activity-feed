            ...
            if (
              ...
              return (
                <React.Fragment>
                  ...
                  <KeyboardAccessory verticalOffset={-50}>
                    <StatusUpdateFormInner {...this.props} {...appCtx} />
                  </KeyboardAccessory>
                </React.Fragment>
              );
  ...
  async addActivity() {
    ...
    if (this.props.doRequest) {
      ...
      await this.props.client
        .feed(this.props.feedGroup, this.props.user.id)
      ...
      <View style={[this.props.fullscreen ? { flex: 1 } : { backgroundColor: '#f9f9f9' }]}>
        <View
          style={[
            styles.container,
            { backgroundColor: '#eee' },
            this.props.height ? { height: this.props.height } : { height: 65 },
          ...
          <View style={{ ...styles.newPostContainer, backgroundColor: '#FFF' }}>
            ...
            <View style={{ ...styles.textInput, backgroundColor: '#FFF' }}>
              <TextInput
                ...
                style={this.props.fullscreen ? { flex: 1 } : { backgroundColor: '#FFF', fontSize: 16 }}
                multiline={false}
                onChangeText={(text) => {
                ...
                inputAccessoryViewID={'sendBroadcastId'}
            ...
            <View>
              <TouchableOpacity style={{ paddingTop: 5, flexDirection: "column", justifyContent:"center" }} onPress={this.props.onVisibilityPress}>
              <View style={{justiftyContent:"center", alignItems:"center"}}>

                <Icon name={"remove-red-eye"} color={"#C1C1C6"} size={18}  />
                </View>
                <Text style={{ fontWeight: "600", color: "#C1C1C6", fontSize: 12, textAlign:"center" }}>
                  {this.props.blockedUsers.length > 0 ? "Custom" : "All"}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <SpecialView nativeID={'sendBroadcastId'}>
              ...
              <View style={{ flexDirection: "row", backgroundColor: '#F9F9F9', height: 40 }}>
                ...
                >
                  <Text style={{ fontSize: 16, fontWeight: "700", color: '#FF0B5A' }}>Broadcast</Text>
                </TouchableOpacity>
              </View>
              {/* <View
                style={[
